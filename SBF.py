...
opts = {
    ...
    "output_dir": "/data/qnilab/AD_NPS_R01_2022/ADNI_Data_Fusion/SBF_Outputs/SBF_HCP_YC_8May2025/CDRSB",
     "modalities_order": ['CT', 'PSA'],  # , 'GM', 'AMY', 'TAU'
    "modalities_order_filetypes": [ '.mgh',  '.mgh'],  # , '.gz', '.gz', '.gz'
...
# from SBF_load import SBF_load
from utils3 import SBF_load

print("Loading the imaging data")
img_data,img_info,modalities = SBF_load(opts, nIDPs_train_set, nIDPs_test_targets, nIDPs_validation_targets)
...
pred_best, best_model, loss_all_test, best_corr, final_model, Data_train, Data_validation, Data_test, dictionaries = utils3.SupervisedFLICA(x_train = Data_train, y_train = nIDPs_train_set, x_test = Data_validation, y_test = nIDPs_validation_targets, 
Data_test = Data_test,
